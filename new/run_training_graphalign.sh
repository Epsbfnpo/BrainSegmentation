...
LAMBDA_VOLUME=${LAMBDA_VOLUME:-1.0}
LAMBDA_SHAPE=${LAMBDA_SHAPE:-1.0}
LAMBDA_EDGE=${LAMBDA_EDGE:-1.0}
LAMBDA_SPEC=${LAMBDA_SPEC:-1.0}
LAMBDA_REQUIRED=${LAMBDA_REQUIRED:-1.0}
LAMBDA_FORBIDDEN=${LAMBDA_FORBIDDEN:-1.0}
LAMBDA_SYM=${LAMBDA_SYM:-1.0}
LAMBDA_DYN=${LAMBDA_DYN:-1.0}
PRIOR_WARMUP_EPOCHS=${PRIOR_WARMUP_EPOCHS:-8}
...
DYN_START_EPOCH=${DYN_START_EPOCH:-300}
DYN_RAMP_EPOCHS=${DYN_RAMP_EPOCHS:-240}
DYN_MISMATCH_REF=${DYN_MISMATCH_REF:-0.08}
DYN_MAX_SCALE=${DYN_MAX_SCALE:-3.0}
AGE_RELIABILITY_MIN=${AGE_RELIABILITY_MIN:-0.6}
AGE_RELIABILITY_POW=${AGE_RELIABILITY_POW:-0.45}
EVAL_TTA=${EVAL_TTA:-0}
TTA_AXES=${TTA_AXES:-"0"}
